                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    <div class="header-text">
                                        <h6>Welcome To Valo Gunsmith</h6>
                                        <h4><em>Browse</em> Our Finest Weapons Here</h4>
                                ...
                                <div class="col-lg-12">
                                    <div class="featured-games header-text">
                                        <div class="heading-section">
                                            <h4><em>Featured</em> Collection</h4>
                                        </div>
                                        <div class="owl-features owl-carousel">
                                            <c:forEach items="${list}" var = "item">
                                                <a href="collection?id=${item.getId()}" class="item">
                                                    <div class="thumb">
...
<div class="most-popular">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="heading-section">
                                            <h4><em>Top View</em> Right Now</h4>
                                        </div>
                                        <div class="row">
                                            <c:forEach items="${topList}" var = "item" end="3">
                                                <div class="col-lg-3 col-sm-6">
                                                    <a href="detail?id=${item.getItemId()}" class="item" style="display: block">
                                                        <div class="gun">
                                                            <img src="${item.getImg()}" alt="">
